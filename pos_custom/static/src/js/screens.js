...
function openerp_pos_screens(instance, module){ //module is instance.point_of_sale
    ...
    module.PaymentScreenWidget = module.ScreenWidget.extend({
        ...
        update_payment_summary: function() {
            ...
            //var paidTotal = currentOrder.getPaidTotal();PCAROLI
            ...
            if(this.pos_widget.action_bar){
                ...
                //this.pos_widget.action_bar.set_button_disabled('invoice', !this.is_paid()); //PCAROLI:Enable Invoice Button
        ...
        validate_order: function(options) {
            ...
            //if(!this.is_paid()){PCAROLI: Useless, same check in next if
            //    return;
            //}

            // The exact amount must be paid if there is no cash payment method defined.
            if ((Math.abs(currentOrder.getTotalTaxIncluded() - currentOrder.getPaidTotal()) > 0.00001) || options.invoice) { //PCAROLI: Added invoice
                var cash = false;
